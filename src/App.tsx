...
const handleMouseMove = (event: MouseEvent) => {
  if (isDragging && animationFrameId === null) {
    accumulatedDeltaX += event.movementX / 5;
    accumulatedDeltaY += event.movementY / 5;
...
const updateOffset = () => {
  ...
  if (deltaX || deltaY) {
    setOffset((prevOffset) => ({
      x: prevOffset.x + deltaX / 5,
      y: prevOffset.y + deltaY / 5,
    }));
  }
            ...
            <div id="mapSettings">
              ...
              <div id="mapHeight">
                ...
                <input
                  ...
                  max="1000"
                  value={mapHeight()}
                  onInput={(e) => setMapHeight(parseFloat(e.currentTarget.value))}
                />
              </div>{" "}
              <div id="offsetX">
                ...
                <input
                  ...
                  onInput={(e) =>
                    setOffset({ x: parseFloat(e.currentTarget.value), y: offset().y })
                  }
                />
              </div>
              <div id="offsetY">
                ...
                <input
                  ...
                  onInput={(e) =>
                    setOffset({ x: offset().x, y: parseFloat(e.currentTarget.value) })
                  }
                />
              </div>
            </div>
            <div id="noiseSettings">
              <div id="noiseScale">
                ...
                <input
                  ...
                  max="1000"
                  value={noiseScale()}
                  onInput={(e) => setNoiseScale(parseFloat(e.currentTarget.value))}
                />
              </div>
              <div id="octaves">
                ...
                <input
                  ...
                  step="1"
                  value={octaves()}
                  onInput={(e) => setOctaves(parseFloat(e.currentTarget.value))}
                />
              </div>
              <div id="persistence">
                ...
                <input
                  ...
                  step="0.01"
                  value={persistence()}
                  onInput={(e) => setPersistence(parseFloat(e.currentTarget.value))}
                />
              </div>
              <div id="lacunarity">
                ...
                <input
                  ...
                  step="0.01"
                  value={lacunarity()}
                  onInput={(e) => setLacunarity(parseFloat(e.currentTarget.value))}
                />
              </div>
              <div id="amplitude">
              ...
              <div id="fbm">
                ...
                <input
                  ...
                  id="fbm"
                  checked={fbm()}
                  onInput={(e) => setFbm(e.currentTarget.checked)}
                />
              </div>
              <div id="domainWarping">
                ...
                <input
                  type="checkbox"
                  id="domainWarping"
                  checked={domainWarping()}
                  onInput={(e) => setDomainWarping(e.currentTarget.checked)}
                />
              </div>
              <div id="warpScale">
                ...
                <input
                  ...
                  step="0.1"
                  value={warpScale()}
                  onInput={(e) => setWarpScale(parseFloat(e.currentTarget.value))}
                />
              </div>
              <div id="warpIntensity">
                ...
                <input
                  ...
                  step="0.1"
                  value={warpIntensity()}
                  onInput={(e) => setWarpIntensity(parseFloat(e.currentTarget.value))}
                />
              </div>
            </div>
          </div>
